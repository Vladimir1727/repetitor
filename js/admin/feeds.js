...
function deldiag(id){
	$( "#deldialog" ).remove();
	var body = '<div id="deldialog" title="Очистить сообщение?">';
	body += '<form action="clearFeed" method="post">';
	body += '<button id="del" name="del" type="submit" class="ui-button ui-corner-all ui-widget">Очистить</button>';
