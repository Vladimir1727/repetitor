...
$customData = array ('student_id' => $student['id']);
 ?>
<form class="hidden" action="https://www.sandbox.paypal.com/cgi-bin/websc" method="post" id="paypal_form">
...
<form class="hidden" method="POST" action="https://money.yandex.ru/quickpay/confirm.xml"  id="yandex_form">
    ...
    <input type="hidden" name="short-dest" value="Оплата за урок репетитору">
